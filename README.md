...
[![Version](https://img.shields.io/badge/version-2.5.0-blue.svg)](https://github.com/fwaeytens/burp-mcp-bridge/releases)
...
4. Choose `extension/target/burp-mcp-bridge-2.5.0.jar`
...
2. **"Unknown tool" errors**
   ...
   - ✅ Verify version 2.5.0 is loaded
...
**Current Version**: 2.5.0 | **Burp Suite**: 2026.4+ | **Tools**: 22 | **Status**: Production Ready with AI-Powered Anomaly Detection
